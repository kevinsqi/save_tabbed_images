...
React.render(React.createElement(SaveImageDialog, null), document.getElementById('popup'));

},{"./save_image_dialog.jsx":2,"react":159}],2:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
  ...
  downloadOptions: function() {
    return (
      React.createElement("form", {id: "download-options"}, 
    ...
    if (this.hasImages()) {
      content = (
        React.createElement("div", null, 
          React.createElement("button", {id: "download"}, "Download ", pluralize('image', this.imageCount(), true)), 
          this.downloadOptions(), 
          React.createElement("ul", {id: "links"}, 
            this.state.imageTabList.map(this.imageTabListItem)
          ), 
          this.state.isComplete ? React.createElement("button", {id: "close-tabs"}, "Close Downloaded Tabs") : null
        )
      );
    } else {
      content = (
        React.createElement("div", null, 
          React.createElement("p", {id: "message"}, "No images opened as tabs in current window."), 
...
},{"pluralize":4,"react":159}],3:[function(require,module,exports){
